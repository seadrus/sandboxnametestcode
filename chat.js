...
var chatOptions = {
	look: {
		...
		backgroundColor: getCookie("customisation", 0),
                modalIcon: "http://icons.iconarchive.com/icons/deleket/soft-scraps/256/Gear-icon.png"
	},
	modules: {
		chatHacks: {
			element: "#chatHacks",
